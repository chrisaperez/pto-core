...
//
// cuttag_profiler: the output-overwrites-input guard (include/profiler/file_identity.hpp).
//
...
using profiler::output_overwrites_input;
using profiler::same_regular_file;
...
int main() {
    testing::Suite suite{"cuttag/file_identity", {}};
