...
//
// pto-peaks: the output-overwrites-input guard (include/peaks/file_identity.hpp).
//
...
using pto::peaks::output_overwrites_input;
using pto::peaks::same_regular_file;
...
int main() {
    testing::Suite suite{"peaks/file_identity", {}};
