...
\input{table_pareto_benchmarks.tex}
...
\input{table_concordance_exactness.tex}
...
\input{table_peak_concordance.tex}
...
end to end against a deployed cloud stack rather than only against mocked
cloud services. That path comprises API submission, a managed queue, a
dispatcher, one ephemeral compute task per job, and a callback consumer that
